...
@WebServlet(urlPatterns = "/MyWorkerServlet")
public class MyWorkerServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(mymessage!=null){
            for(Message m :mymessage){
                if(m.getSession_Id().equals("行政部")) {
                    pw.write("<tr id='user_" + m.getWorker_Id() + "'name='user_" + m.getWorker_Id() + "'>");
