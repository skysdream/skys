...
@WebServlet(urlPatterns = "/ChangeMyMessageServlet")
public class ChangeMyMessageServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        response.setContentType("text/html;charset=UTF-8");
        Message message = new Message();
        message.setWorker_Id(Integer.parseInt(request.getParameter("user1_workid")));
        ...
        boolean flag=messageDao.updateSingerMessage(message);
